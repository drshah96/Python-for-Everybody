...
### Graded Assignment 1: Extracting Data from JSON
import urllib.error
import json

url_sample = 'http://py4e-data.dr-chuck.net/comments_42.json'
url = 'http://py4e-data.dr-chuck.net/comments_445372.json'
...
### Graded Assignment 2: Finding Place id for Beloit College
import urllib.error
import json
import ssl
